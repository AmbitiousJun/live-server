...
func (h *remoteM3UHandler) HelpDoc() string {
	...
	sb.WriteString("\n4. 频道名传递方式：")
	sb.WriteString("\n&nbsp;&nbsp;4.1 假设有如下 m3u 的直播源 A 信息: #EXTINF:-1 tvg-name=\"寰宇新闻1\" tvg-id=\"寰宇新闻2\" group-title=\"港澳台及国外\",寰宇新闻3")
	sb.WriteString("\n&nbsp;&nbsp;4.2 传递频道名称 ch 参数时, 使用 [寰宇新闻1, 寰宇新闻2, 寰宇新闻3] 中的任意一个都能够匹配到当前频道源")
	sb.WriteString("\n&nbsp;&nbsp;4.3 假设除了直播源 A 之外还有直播源 B 信息: #EXTINF:-1 tvg-name=\"寰宇新闻4\" tvg-id=\"寰宇新闻3\" group-title=\"港澳台及国外\",寰宇新闻2")
	sb.WriteString("\n&nbsp;&nbsp;4.4 A 和 B 中有部分信息是重叠的, 这时可以通过 format 参数来指定具体的直播源")
	sb.WriteString("\n&nbsp;&nbsp;4.5 比如: ${clientOrigin}/handler/remote_m3u/ch/寰宇新闻2?url_env=remote_m3u_v6&format=1 可以指定使用直播源 A")
	sb.WriteString("\n&nbsp;&nbsp;4.6 同理, 传递 format=2 可以指定使用直播源 B")
	sb.WriteString("\n&nbsp;&nbsp;4.7 如果出现信息重叠且没有传递 format 参数, 默认使用第一个直播源")
	return sb.String()
}
